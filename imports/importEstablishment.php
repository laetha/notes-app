...
$sql = "SELECT * FROM world WHERE type LIKE 'establishment' && worlduser LIKE 'tarfuin'";
...
while($row =  mysqli_fetch_array($sqldata, MYSQLI_ASSOC)) {
  ...
  $location = mysqli_real_escape_string($dndcon, $row['est_location']);  // Escape special characters  $location = $row['est_location'];
