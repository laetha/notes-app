...
map.on('click', onMapClick);
 ...
 $(document).ready(function() {
    $('#headnav').addClass('nonav');
    $('#nonav').css('display','none');
...
var mappoint = new L.latLng(<?php echo $id; ?>);
popup
.setLatLng(mappoint)
.setContent("You clicked the map at " + mappoint.toString())
.openOn(map);
map.setView(new L.LatLng(<?php echo $id; ?>));
<?php } ?>
</script>
