...
$sql = "SELECT * FROM world WHERE title LIKE '$bodyID'";
...
while($row =  mysqli_fetch_array($sqldata, MYSQLI_ASSOC)) {
  ...
  echo ('<h2><a href="https://dnd.bkconnor.com/tools/world/world.php?id='.$row['title'].'" target="_BLANK">'.$row['title'].'</a></h2>');
...
$sql1data = mysqli_query($dndcon, $sql1) or die('error getting data');
while($row1 =  mysqli_fetch_array($sql1data, MYSQLI_ASSOC)) {
  ...
  $body = preg_replace($pattern,'<span class="d-inline-block hovershow" data-placement="auto" data-toggle="popover" data-content="'.nl2br($row1['body']).'"><a href="https://dnd.bkconnor.com/tools/world/world.php?id='.$row1['title'].'" target="_BLANK">'.$row1['title'].'</a></span>',$body);
  $npclocation = preg_replace($pattern,'<span class="d-inline-block hovershow" data-placement="auto" data-toggle="popover" data-content="'.nl2br($row1['body']).'"><a href="https://dnd.bkconnor.com/tools/world/world.php?id='.$row1['title'].'" target="_BLANK">'.$row1['title'].'</a></span>',$npclocation);
  $npcfaction = preg_replace($pattern,'<span class="d-inline-block hovershow" data-placement="auto" data-toggle="popover" data-content="'.nl2br($row1['body']).'"><a href="https://dnd.bkconnor.com/tools/world/world.php?id='.$row1['title'].'" target="_BLANK">'.$row1['title'].'</a></span>',$npcfaction);
  $npcdeity = preg_replace($pattern,'<span class="d-inline-block hovershow" data-placement="auto" data-toggle="popover" data-content="'.nl2br($row1['body']).'"><a href="https://dnd.bkconnor.com/tools/world/world.php?id='.$row1['title'].'" target="_BLANK">'.$row1['title'].'</a></span>',$npcdeity);
  $npcest = preg_replace($pattern,'<span class="d-inline-block hovershow" data-placement="auto" data-toggle="popover" data-content="'.nl2br($row1['body']).'"><a href="https://dnd.bkconnor.com/tools/world/world.php?id='.$row1['title'].'" target="_BLANK">'.$row1['title'].'</a></span>',$npcest);
  $esttype = preg_replace($pattern,'<span class="d-inline-block hovershow" data-placement="auto" data-toggle="popover" data-content="'.nl2br($row1['body']).'"><a href="https://dnd.bkconnor.com/tools/world/world.php?id='.$row1['title'].'" target="_BLANK">'.$row1['title'].'</a></span>',$esttype);
  $estlocation = preg_replace($pattern,'<span class="d-inline-block hovershow" data-placement="auto" data-toggle="popover" data-content="'.nl2br($row1['body']).'"><a href="https://dnd.bkconnor.com/tools/world/world.php?id='.$row1['title'].'" target="_BLANK">'.$row1['title'].'</a></span>',$estlocation);
  $npclink = ('<span class="d-inline-block hovershow" data-placement="auto" data-toggle="popover" data-content="'.nl2br($row1['body']).'"><a href="https://dnd.bkconnor.com/tools/world/world.php?id='.$row1['title'].'" target="_BLANK">'.$row1['title'].'</a> :: '.$row1['npc_title'].'</span>');
  $estlink = ('<span class="d-inline-block hovershow" data-placement="auto" data-toggle="popover" data-content="'.nl2br($row1['body']).'"><a href="https://dnd.bkconnor.com/tools/world/world.php?id='.$row1['title'].'" target="_BLANK">'.$row1['title'].'</a> :: '.$row1['npc_title'].'</span>');
